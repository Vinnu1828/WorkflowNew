...
from workflowapp.models import Employee, Holiday, HolidayDepartment, HolidayLocation, Team, TeamMember, PreliminaryTask, \
    Document, Dharani, Request, ProhibitedLand, Encumbrance, LegalCase, Checklist, Checklistanswer, Urbanland
...
def save_preliminary_task(request):
    ...
    try:
        ...
        Request.objects.filter(id=req_id).update(requeststatus='I')
